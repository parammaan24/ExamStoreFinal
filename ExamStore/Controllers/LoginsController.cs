...
namespace ExamStore.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public LoginsController(ExamStoreContext context)
        {
            _context = context;
        }
        ...
        public IActionResult BookPannel()
        {
            return View();
        }

        public IActionResult InvalidDetails()
        {
            return View();
        }
        ...
        {
            if (login.Email.Equals("Book@gmail.com") && login.Password.Equals("Book"))
            {

                return RedirectToAction(nameof(BookPannel));
            }
            else {
                return RedirectToAction(nameof(InvalidDetails));
            }
